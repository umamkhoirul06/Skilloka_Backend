...
<body class="antialiased text-gray-800 flex h-screen overflow-hidden">
    ...
    <aside class="w-72 sidebar flex flex-col transition-all duration-300 z-50">
        ...
        <nav class="mt-6 flex-1 overflow-y-auto pb-4">
            ...
            <a href="{{ route('super.tenants') }}" class="menu-item {{ str_contains($currentRoute, 'tenant') ? 'active' : '' }}">
                <span class="menu-icon"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg></span>
                LPK Centers
            </a>

            <a href="{{ route('super.verifications') }}" class="menu-item {{ str_contains($currentRoute, 'verification') ? 'active' : '' }}">
                <span class="menu-icon"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span>
                Verifications
            </a>

            <a href="{{ route('super.users') }}" class="menu-item {{ str_contains($currentRoute, 'user') ? 'active' : '' }}">
                <span class="menu-icon"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg></span>
                Users Management
            </a>

            <a href="{{ route('super.finance') }}" class="menu-item {{ str_contains($currentRoute, 'finance') ? 'active' : '' }}">
                <span class="menu-icon"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span>
                Finance
            </a>

            <a href="{{ route('super.logs') }}" class="menu-item {{ str_contains($currentRoute, 'log') ? 'active' : '' }}">
                <span class="menu-icon"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></span>
                System Logs
            </a>

            <a href="{{ route('super.settings') }}" class="menu-item {{ str_contains($currentRoute, 'setting') ? 'active' : '' }}">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit" class="menu-item w-full text-left group hover:text-red-400">
                    <span class="menu-icon group-hover:text-red-400"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg></span>
                    Logout
                </button>
            </form>
        </nav>
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden bg-[#f4f7fb]">
        ...
        <header class="glass-header px-8 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <!-- Notifications -->
                <button class="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-emerald-500 hover:border-emerald-200 transition-colors shadow-sm">
