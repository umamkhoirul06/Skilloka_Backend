                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="flex-shrink-0 h-12 w-12 rounded-lg bg-gray-100 overflow-hidden border border-gray-200">
                                            @if(!empty($course->images) && count($course->images) > 0)
                                                <img class="h-12 w-12 object-cover"
                                                    src="{{ asset('storage/' . $course->images[0]) }}" alt="{{ $course->title }}">
                                            @else
                                                <div
                                                    class="h-12 w-12 flex items-center justify-center bg-indigo-50 text-indigo-300">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-xs text-gray-500 mt-0.5">{{ $course->duration_hours }} Jam • Max
                                                {{ $course->max_participants ?? '-' }} Org</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
