...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- CARD -->
        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
            ...
            <div class="w-12 h-12 rounded-lg bg-indigo-50 flex items-center justify-center border border-indigo-100">
                <svg class="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2"></path></svg>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-bold text-emerald-600 mt-1">{{ $bookings->where('payment_status','paid')->count() }}</h3>
            </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-bold text-amber-500 mt-1">{{ $bookings->where('payment_status','pending')->count() }}</h3>
            </div>
            <div class="w-12 h-12 rounded-lg bg-amber-50 flex items-center justify-center border border-amber-100">
                <svg class="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3"></path></svg>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 p-6 flex items-center justify-between">
            <div>
                ...
                <h3 class="text-xl font-bold text-purple-600 mt-1">Rp {{ number_format($bookings->where('payment_status','paid')->sum('amount'),0,',','.') }}</h3>
            </div>
            <div class="w-12 h-12 rounded-lg bg-purple-50 flex items-center justify-center border border-purple-100">
                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3 1.343 3 3-1.343 3-3 3m0-12V4m0 8v8"></path></svg>
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50/50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Siswa</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Kursus</th>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-700">{{ Str::limit($booking->schedule->course->title ?? '-', 35) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-semibold text-gray-900">Rp {{ number_format($booking->amount,0,',','.') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.bookings.show', $booking) }}" class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="Detail">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-500">
                                <svg class="w-12 h-12 text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
