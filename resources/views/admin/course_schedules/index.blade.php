                    ...
                    <thead class="bg-gray-50/50">
                        <tr>
                            ...
                            <th scope="col"
                                ...
                                Hari</th>
                            <th scope="col"
                                class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Jam
                            </th>
                            <th scope="col"
                                class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                Kuota</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 font-medium">
                                        {{ \Carbon\Carbon::parse($schedule->start_date)->format('d M Y') }}</div>
                                    <div class="text-xs text-gray-500 mt-0.5">s.d
                                        {{ \Carbon\Carbon::parse($schedule->end_date)->format('d M Y') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $schedule->max_capacity }} <span
                                            class="text-gray-500 text-xs font-normal">orang</span></div>
                                </td>
                            </tr>
                        @empty
                            <tr>
